...
func (cb RustBuffer) Free() {
	rustCall(func(status *C.RustCallStatus) bool {
		C.ffi_testrust_rustbuffer_free(cb, status)
		return false
	})
}
...
func bytesToRustBuffer(b []byte) RustBuffer {
	...
	return rustCall(func(status *C.RustCallStatus) RustBuffer {
		return C.ffi_testrust_rustbuffer_from_bytes(foreign, status)
	})
}
...
func uniffiCheckChecksums() {
	...
	scaffoldingContractVersion := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.ffi_testrust_uniffi_contract_version(uniffiStatus)
	})
	if bindingsContractVersion != int(scaffoldingContractVersion) {
		// If this happens try cleaning and rebuilding your project
		panic("testrust: UniFFI contract version mismatch")
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_testrust_checksum_func_add(uniffiStatus)
		})
		if checksum != 40038 {
			// If this happens try cleaning and rebuilding your project
			panic("testrust: uniffi_testrust_checksum_func_add: UniFFI API checksum mismatch")
		}
	}
}
...
func Add(a uint32, b uint32) uint32 {
	return FfiConverterUint32INSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.uniffi_testrust_fn_func_add(FfiConverterUint32INSTANCE.Lower(a), FfiConverterUint32INSTANCE.Lower(b), _uniffiStatus)
	}))
}
